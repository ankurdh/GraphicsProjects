...
RightHandBelowElbow::RightHandBelowElbow(ref_ptr<MatrixTransform> transform) : MyBodyPart(transform)
    {
...
bool RightHandBelowElbow::handle(const GUIEventAdapter & ea, GUIActionAdapter & aa)
    {
    Matrix m;
...
RightHandBelowElbow::~RightHandBelowElbow(void)
    {
    }
