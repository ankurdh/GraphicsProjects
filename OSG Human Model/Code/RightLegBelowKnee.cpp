...
RightLegBelowKnee::RightLegBelowKnee(ref_ptr<MatrixTransform> transform) : MyBodyPart(transform)
    {
...
bool RightLegBelowKnee::handle(const GUIEventAdapter & ea, GUIActionAdapter & aa)
    {
    Matrix m;
...
RightLegBelowKnee::~RightLegBelowKnee(void)
    {
    }
